...
$document.ready(function () {
  ...
  if (plugins.rdGoogleMaps.length) {
    ...
    $.getScript("//maps.google.com/maps/api/js?key=AIzaSyD7V7rhiO4MiFQFktsThq7KWWa1RkvQQyc&sensor=false&libraries=geometry,places&v=3.7", function () {
